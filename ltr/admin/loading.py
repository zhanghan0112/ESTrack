...
def torch_load_legacy(path):
    ...
    # Load network
    # path_new = '/home/zxh/project/TransT/checkpoints/ltr/siamcar/siamcar_new_ddp/SiamCAR_new_ep0200.pth.tar'
    # ckpt_new = torch.load(path_new, map_location='cpu')
    checkpoint_dict = torch.load(path, map_location='cpu')
    # checkpoint_dict['net'] = ckpt_new
