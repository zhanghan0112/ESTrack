...
def main():
    ...
    parser.add_argument('--train_module', default='siamyolo', type=str, help='Name of module in the "train_settings/" folder.')
    parser.add_argument('--train_name', default='siamyolo', type=str, help='Name of the train settings file.')
