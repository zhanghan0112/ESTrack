...
from ltr.models.loss.siamLoss import MSELoss,SigmoidCrossEntropyRetina
...
def run(settings):
    ...
    dataset_train = sampler.siamyoloSampler([lasot_train], [1],
                                        samples_per_epoch=settings.data_sample_epoch, max_gap=settings.data_max_gap,
                                        num_template_frames=settings.data_num_template, num_search_frames=settings.data_num_search,
                                        processing=data_processing_train,frame_sample_mode=settings.frame_sample_mode,response_map=settings.response_map,
    ...
    objective = {'clsloss':SigmoidCrossEntropyRetina(),
                 'txtyloss':nn.L1Loss(),'twth_loss':nn.L1Loss()}
    ...
    param_dicts = [
        ...
        {"params": model.neck_z.parameters()},
        {"params": model.neck_x.parameters()},
        {"params": model.adjust_weight.parameters()},
