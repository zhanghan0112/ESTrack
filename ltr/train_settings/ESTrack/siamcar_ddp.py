...
import ltr.models.tracking.siamcar as siamcar
...
def run(settings):
    ...
    data_processing_val = processing.siamCARProcessing(search_area_factor=settings.search_area_factor,
                                                    template_area_factor=settings.template_area_factor,
                                                    search_sz=settings.search_sz,
                                                    temp_sz=settings.temp_sz,
                                                    sigma=settings.output_sigma_factor / settings.search_area_factor,
    ...
    model = siamcar.siamcar_resnet50(backbone_pretrained=True,head_name='siamCAR')
