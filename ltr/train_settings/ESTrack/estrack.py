...
def run(settings):
    ...
    dataset_train = sampler.ESTrackSampler([got10k_train], [1],
                                        ...
                                        frame_sample_mode=settings.frame_sample_mode, neg=settings.neg_sample)
    ...
    objective = {'clsloss':SigmoidCrossEntropyRetina(), 'centerloss':SigmoidCrossEntropyCenterness(),
                 'iouloss':IOULoss()}
